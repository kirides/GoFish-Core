...
namespace GoFish.DataAccess
{
    public class Dbf
    {
        ...
        public Stream OpenMemo()
        {
            ...
            return new FileStream(memoPath, FileMode.Open, FileAccess.Read, FileShare.Read, short.MaxValue, FileOptions.RandomAccess);
        }

        public Stream OpenReadOnly()
        {
            return new FileStream(dbfPath, FileMode.Open, FileAccess.Read, FileShare.Read, 16_384, FileOptions.SequentialScan);
        }

        public Stream OpenReadOnlyAsync()
        {
            return new FileStream(dbfPath, FileMode.Open, FileAccess.Read, FileShare.Read, 16_384, FileOptions.SequentialScan | FileOptions.Asynchronous);
        }

...
public class DbfReader
{
    ...
    public bool[] IncludeFieldIndices { get; }
    ...
    public DbfReader(Dbf dbf, Encoding textEncoding)
    {
        ...
        IncludeFieldIndices = new bool[dbfHeader.Fields.Count];
        Array.Fill(IncludeFieldIndices, true);
    }
    ...
    private object[] ReadRowFromBuffer(ReadOnlySpan<byte> rowBuf, int index)
    {
        ...
        for (var i = 0; i < rowData.Length; i++)
        {
            ...
            if (!IncludeFieldIndices[field.Index]) continue;
